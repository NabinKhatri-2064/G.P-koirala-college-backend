...
export type StorageHash =
  StorageHashBase<'98e88f0006c69e8d4b0ad9e98cdb0519bffb39a51875a78e0a66ed08386f3890'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly addfeaturednews: {
      ...
      readonly firstparagraph: CodecTypes['pg/text@1']['output'];
      readonly secondparagraph: CodecTypes['pg/text@1']['output'];
    };
    readonly admissionform: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly mobilenumber: CodecTypes['pg/text@1']['output'];
      readonly email: CodecTypes['pg/text@1']['output'];
      readonly interestedin: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly addfeaturednews: {
      ...
      readonly firstparagraph: CodecTypes['pg/text@1']['input'];
      readonly secondparagraph: CodecTypes['pg/text@1']['input'];
    };
    readonly admissionform: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      ...
      readonly interestedin: CodecTypes['pg/text@1']['input'];
...
> & {
  ...
  readonly roots: {
    readonly admissionform: {
      ...
      readonly model: 'admissionform';
    };
    readonly addfeaturednews: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'addfeaturednews';
    };
    readonly news: { readonly namespace: 'public' & NamespaceId; readonly model: 'News' };
    readonly user: { readonly namespace: 'public' & NamespaceId; readonly model: 'User' };
    readonly blanket: { readonly namespace: 'public' & NamespaceId; readonly model: 'blanket' };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly addfeaturednews: {
            ...
            readonly storage: {
              readonly table: 'addfeaturednews';
              ...
              readonly fields: {
                ...
                readonly firstparagraph: { readonly column: 'firstparagraph' };
                readonly secondparagraph: { readonly column: 'secondparagraph' };
              };
            };
          };
          readonly admissionform: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly interestedin: { readonly column: 'interestedin' };
